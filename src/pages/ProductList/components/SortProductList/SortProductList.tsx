...
const SortProductList = ({ queryConfig, pageSize }: Props) => {
  ...
  //ProductListConfig['sort_by'] để lấy sort_by trong
  // Exclude loại bỏ các giá trị ra khỏi union type ở đây loại bỏ undefined ra khỏi union type
      ...
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <select
            ...
            // ban đầu ko có order thì ta show option `giá`
            value={order || ''}
            // Vì e.target.value là string mà orderValue nhận vào 'desc' | 'asc' nên string chưa đủ chi tiết nên là ép kiểu (biết chắc nó chỉ nằm 2 giá trị này thôi)

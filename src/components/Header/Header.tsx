...
const Header = () => {
  ...
  const logoutMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      // khi logout thì xóa query có queryKey là purchase
      queryClient.removeQueries({ queryKey: ['purchases', { status: purchasesStatus.inCart }] })
    }
  })

  // Khi chúng ta chuyển trang thì Header chỉ bị re render. Chứ không bị unMount - Mounting again.
  // Trừ trường hợp logout rồi nhảy sang RegisterLayout rồi nhảy vào lại. Nên các query này không bị inactive (là nó bắt đầu tính thời gian nó bị xóa) => Không bị gọi lại => Không cần phải set stale: Infinity
  const { data: purchasesInCartData } = useQuery({
    queryKey: ['purchases', { status: purchasesStatus.inCart }],
    queryFn: () => purchaseApi.getPurchases({ status: purchasesStatus.inCart }),

    // Nó gọi khi đã login thành công
      ...
      <div className='container'>
        <div className='flex justify-end'>
          <Popover
            ...
            renderPopover={
              <div className='relative z-20 rounded-sm border border-gray-200 bg-white shadow-md'>
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          ...
          <div className='cols-span-1 justify-self-end'>
            <Popover
              ...
              renderPopover={
                <div className='relative z-20 max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  {purchasesInCart ? (
                    <div className='p-2'>
                        ...
                        {purchasesInCart.slice(0, 5).map((purchase) => (
                          <div className='mt-2 flex py-2 hover:bg-gray-100' key={purchase._id}>
                            <div className='flex-shrink-0'>
                              <img src={purchase.product.image} alt='anh' className='h-11 w-11 object-cover' />
                            </div>
            ...
            >
              <Link to='/' className='relative'>
                ...
                {purchasesInCart && (
                  <span className='absolute top-[-5px] left-[17px] rounded-full bg-white py-[1px] px-[9px] text-orange'>

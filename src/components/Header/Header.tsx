                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://i.pinimg.com/564x/5c/1d/70/5c1d70c2a1461829bdb45513b80e096b.jpg'
                            alt='anh'
                            className='h-11 w-11 object-cover'
                          />
                        </div>
                        <div className='ml-2 flex-grow overflow-hidden'>
                          <div className='truncate'>Apple MacBook Air M1 256GB 2020</div>
                        </div>
                        <div className='ml-2 flex-shrink-0 '>
                          <span className='text-orange'>30000000</span>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
